// file downloaded from: http://wiki-android.blogspot.com/2012/12/creating-android-ftp-client-ftp.html
    ...
    public boolean ftpConnect(String host, String username, String password, int port) {
        try {
            ...
            if (FTPReply.isPositiveCompletion(mFTPClient.getReplyCode())) {
                 ...
                 * specified a correct transfer mode, such as ASCII_FILE_TYPE,
                 * BINARY_FILE_TYPE, EBCDIC_FILE_TYPE .etc. Here, I use
                 * BINARY_FILE_TYPE for transferring text, image, and compressed
                 * files.
                 */
